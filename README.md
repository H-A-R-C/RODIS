...
Core/                          RODIS.Core model and console entry point
  ...
  SimpleTests/                 Synthetic test scenarios and RODIS outputs
    ...
    ScenarioNN/
      ...
      RODISOutputs/            Outputs regenerated by running the scenario
```
...
The comparison harness itself is retained in `tests` and will run against reference outputs if they are supplied; see the test category notes below.
...
Development of RODIS was supported by the Murray–Darling Basin Authority and the Runoff Dams Working Group through the Runoff Dams Pilot Study and Business Case.
